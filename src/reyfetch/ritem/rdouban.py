...
class DatabaseORMTableDoubanMedia(rorm.Table):
    ...
    premiere: str = rorm.Field(rorm.dialect.JSONB, comment='Premiere region and date dictionary.')
    country: str = rorm.Field(rorm.dialect.JSONB, comment='Release country list.')
    class_: str = rorm.Field(rorm.dialect.JSONB, comment='Class list.', name='class')
    director: str = rorm.Field(rorm.dialect.JSONB, comment='Director list.')
    star: str = rorm.Field(rorm.dialect.JSONB, comment='Star list.')
    scriptwriter: str = rorm.Field(rorm.dialect.JSONB, comment='Scriptwriter list.')
    language: str = rorm.Field(rorm.dialect.JSONB, comment='Language list.')
    alias: str = rorm.Field(rorm.dialect.JSONB, comment='Alias list.')
    comment: str = rorm.Field(rorm.dialect.JSONB, comment='Comment list.')
